...
if("TRUE" STREQUAL "TRUE")
  set(baldor_SOURCE_PREFIX /home/matt/JBOT_Working/catkin_ws/src/baldor)
  set(baldor_DEVEL_PREFIX /home/matt/JBOT_Working/catkin_ws/devel/.private/baldor)
  set(baldor_INSTALL_PREFIX "")
  set(baldor_PREFIX ${baldor_DEVEL_PREFIX})
else()
  set(baldor_SOURCE_PREFIX "")
  set(baldor_DEVEL_PREFIX "")
  set(baldor_INSTALL_PREFIX /home/matt/JBOT_Working/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baldor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matt/JBOT_Working/catkin_ws/src/baldor/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/matt/JBOT_Working/catkin_ws/devel/.private/baldor/lib;/home/matt/JBOT_Working/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND baldor_EXPORTED_TARGETS ${${baldor_dep}_EXPORTED_TARGETS})
endforeach()
